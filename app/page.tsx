...
const appFeatures = [
  { name: "CRM", icon: "crm" },
  { name: "Asystent AI", icon: "ai" },
  { name: "Faktury", icon: "invoices" },
  { name: "Projekty", icon: "projects" },
  { name: "Klienci", icon: "clients" },
  { name: "Automatyzacje", icon: "automations" },
];
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-sm font-semibold tracking-[0.24em] text-[#5596ff]">EKOSYSTEM XENLY</p>
            ...
            <p className="mt-6 text-lg leading-8 text-slate-400 sm:text-xl">
              Już wkrótce udostępnimy nowoczesną platformę do zarządzania firmą, klientami, projektami, marketingiem oraz automatyzacjami AI.
            </p>
            <span className="mt-6 inline-flex rounded-full border border-[#5794ff]/45 bg-[#16356e]/50 px-3 py-1 text-xs font-semibold text-[#92bdff]">
              Już wkrótce
            </span>
          </div>
